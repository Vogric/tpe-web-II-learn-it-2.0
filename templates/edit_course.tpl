...
<div class="container">
  ...
  <div class="text-center py-3 px-4">
    <div class="py-2">
      <th><input type="button" class="btn blue-gradient btn-sm" type="submit" value="Update" /></th>
      <th><input type="button" class="btn purple-gradient btn-sm" type="reset" value="Reset" /></th>
    </div>
  </div>
...
{* <form action="admin/courses/edit/{$course_s->id}" method="POST">
  <input type="text" name="title" value="{$course_s->title}" placeholder="Title" />
  <input type="number" name="duration" value="{$course_s->duration}" placeholder="Duration" />
  <input type="number" name="time_commitent" value="{$course_s->time_commitent}" placeholder="Time commitent" />
  ...
  <input type="text" name="difficulty" value="{$course_s->difficulty}" placeholder="Difficulty" />
  <input type="text" name="topics" value="{$course_s->topics}" placeholder="Topics" />
